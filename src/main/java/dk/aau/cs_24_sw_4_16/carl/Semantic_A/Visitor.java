...
//
//    boolean printypes = true;// ! SLET SENERE
//
...
//                            node.getArgument(i)));
//                }
//                AstNode test = visit(function.getBlock());//! Denne her skal have statements
//
...
//            visit((FunctionCallNode) node.getNode());
//        } else if (node.getNode() instanceof RelationsAndLogicalOperatorNode) {
//            visit((RelationsAndLogicalOperatorNode) node.getNode());
//        } else if (node.getNode() instanceof BinaryOperatorNode) {
//            visit((BinaryOperatorNode) node.getNode());
//        }
//    }
